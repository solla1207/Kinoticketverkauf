...
import Beobachtmuster.Beobachter;
...
public class KassenWerkzeug
{
    ...
    private void registriereUIAktionen()
    {
        ...
        _datumAuswaehlWerkzeug.registiereBeobachter(new Beobachter()
        {
        ...
        _vorstellungAuswaehlWerkzeug.registiereBeobachter(new Beobachter()
        {
